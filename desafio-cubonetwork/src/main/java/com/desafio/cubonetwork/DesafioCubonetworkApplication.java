...
public class DesafioCubonetworkApplication implements CommandLineRunner {
	...
	private void createMockParticipants() {
		...
		andersonSantos.addParticipation(BigDecimal.valueOf(40));
